...
<div class="col-12">
  <div class="card">
    <div class="card-body">
      <div class="mb-5">
        <h2 class="card-title text-4xl ml-3">Manage User</h2>
      </div>

      <table class="mb-5 ml-8">
        <td class="w-1/2">
      ...
      <table class="w-full mx-2 border-gray-700">
        ...
        <tbody class="text-center">
          <tr class="border-b-2">
            ...
            <td>Rp 100.000,-</td>
            <td>
              <a class="py-2 px-4 border-2 rounded-2xl border-red-500 hover:bg-red-500 hover:text-white" href="">Hapus</a>
            </td>
          </tr>
          <tr class="border-b-2">
            <td class="py-4">2</td>
